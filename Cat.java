...
public class Cat extends Animal {
    ...
    public Cat(String name, SexEnum sex, int age, Location currentLocation, Owner owner, String breed) {
...
////////////////////////////// Animal class methods //////////////////////////////////////////////////////////////
    ...
    public void displayFullAnimalInfo(Animal animal){
        ...
        System.out.println("Breed: " +((Cat)animal).getBreed());
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Cat){
            ...
            if (cat.getName().equals(this.getName())
                    && Objects.equals(cat.getSex(),this.getSex())
                    && cat.getAge() == this.getAge()
                    && cat.getOwner().equals(this.getOwner())
                    && cat.getBreed().equals(this.getBreed()))
                result = true;
        }
        return result;
    }
